      ...
      <div class="block-content">
        ...
        <div class="row mb-3">
          ...
          <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
              <label>Parent</label>
              {!! Form::select('parent_id', $locations, $location->parent_id, array('placeholder' => 'Select a Location','class' => 'form-control form-control-alt')) !!}
            </div>
          </div>
          <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
              ...
              <select class="js-select2 form-control" name="manager_id" style="width: 100%;" data-placeholder="Select a User">
                ...
                <option value="{{ $id }}" @if($location->manager_id == $id) selected @endif>{{ $name }}</option>
                @endforeach
              </select>
            </div>
          </div>
          ...
          <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
              <label>Country</label>
              {!! Form::select('country', $countries, $location->country, array('placeholder' => 'Select a Country','class' => 'form-control form-control-alt')) !!}
            </div>
          </div>
          <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
