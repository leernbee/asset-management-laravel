  ...
  <div class="col-lg-6">
    <div class="block">
      <div class="block-header">
        <h3 class="block-title">Create New Status</h3>
      ...
      <div class="block-content">
        ...
        <div class="row mb-3">
          ...
          <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
              <label>Type</label>
              {!! Form::select('type', ['Deployable' => 'Deployable', 'Pending' => 'Pending', 'Undeployable' => 'Undeployable'],[], array('placeholder' => 'Select a Type', 'class' => 'form-control form-control-alt' . ( $errors->has('type') ? ' is-invalid' : '' ))) !!}
