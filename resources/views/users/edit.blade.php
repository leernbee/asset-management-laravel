        ...
        <div class="row mb-3">
          ...
          <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
              ...
              <input type="text" class="js-datepicker form-control form-control-alt" id="birth_date" name="birth_date" data-week-start="1" data-autoclose="true" data-today-highlight="true" data-date-format="mm-dd-yyyy" data-date-end-date="0d" placeholder="mm-dd-yyyy" value="{{ $user->birth_date }}">
            </div>
          </div>
          <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
          ...
          <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
              ...
              {!! Form::select('location_id', $locations, $user->location_id, array('class' => 'form-control form-control-alt' . ( $errors->has('location_id') ? ' is-invalid' : '' ))) !!}
          ...
          <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
              <label>Role</label>
              {!! Form::select('roles[]', $roles, $userRole, array('class' => 'form-control form-control-alt' . ( $errors->has('roles') ? ' is-invalid' : '' ),'multiple')) !!}
