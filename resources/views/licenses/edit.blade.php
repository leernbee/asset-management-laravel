  ...
  <div class="col-lg-6">
    <div class="block">
      <div class="block-header">
        <h3 class="block-title">Edit License</h3>
      ...
      <div class="block-content">
        ...
        {!! Form::model($license, ['method' => 'PATCH','route' => ['licenses.update', $license->id]]) !!}
        <div class="row mb-3">
          ...
          <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
              ...
              {!! Form::select('software_type_id', $software_types, $license->software_type_id, array('class' => 'form-control form-control-alt' . ( $errors->has('software_type_id') ? ' is-invalid' : '' ))) !!}
          ...
          <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
              ...
              <input type="text" class="js-datepicker form-control form-control-alt" id="purchase_date" name="purchase_date" data-week-start="1" data-autoclose="true" data-today-highlight="true" data-date-format="mm-dd-yyyy" placeholder="mm-dd-yyyy" value="{{ $license->purchase_date }}">
            </div>
          </div>
          <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
              <label>Expiration Date</label>
              <input type="text" class="js-datepicker form-control form-control-alt" id="expiration_date" name="expiration_date" data-week-start="1" data-autoclose="true" data-today-highlight="true" data-date-format="mm-dd-yyyy" placeholder="mm-dd-yyyy" value="{{ $license->expiration_date }}">
            </div>
          </div>
          <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
