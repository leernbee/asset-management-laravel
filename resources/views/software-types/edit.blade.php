  ...
  <div class="col-lg-6">
    <div class="block">
      <div class="block-header">
        <h3 class="block-title">Edit Software Type</h3>
        <div class="block-options">
          <a class="btn-block-option" href="{{ route('software-types.index') }}">
      ...
      <div class="block-content">
        ...
        {!! Form::model($softwareType, ['method' => 'PATCH','route' => ['software-types.update', $softwareType->id]]) !!}
        <div class="row mb-3">
