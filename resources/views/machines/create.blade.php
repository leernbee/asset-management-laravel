  ...
  <div class="col-lg-6">
    <div class="block">
      <div class="block-header">
        <h3 class="block-title">Create New Machine</h3>
      ...
      <div class="block-content">
        ...
        {!! Form::open(array('route' => 'machines.store','method'=>'POST')) !!}
        <div class="row mb-3">
          ...
          <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
              ...
              {!! Form::select('machine_type_id', $machine_types,[], array('class' => 'form-control form-control-alt' . ( $errors->has('machine_type_id') ? ' is-invalid' : '' ))) !!}
          ...
          <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
              ...
              {!! Form::select('operating_system_id', $operating_systems,[], array('class' => 'form-control form-control-alt' . ( $errors->has('operating_system_id') ? ' is-invalid' : '' ))) !!}
          ...
          <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
              <label>Active Service Date</label>
              <input type="text" class="js-datepicker form-control form-control-alt" id="service_date" name="service_date" data-week-start="1" data-autoclose="true" data-today-highlight="true" data-date-format="mm-dd-yyyy" placeholder="mm-dd-yyyy">
            </div>
          </div>
          <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
              <label>Status</label>
              {!! Form::select('status_id', $statuses,[], array('class' => 'form-control form-control-alt' . ( $errors->has('status_id') ? ' is-invalid' : '' ))) !!}
