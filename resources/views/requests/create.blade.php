  ...
  <div class="col-lg-6">
    <div class="block">
      <div class="block-header">
        <h3 class="block-title">Create New Request</h3>
              ...
              <div>
                <div class="btn-group btn-group-toggle" data-toggle="buttons">
                  <label class="btn btn-outline-primary btn-toggle active">
                    <input type="radio" name="priority" id="option1" value="None" autocomplete="off" checked> None
                  </label>
                  <label class="btn btn-outline-primary btn-toggle">
                    <input type="radio" name="priority" id="option2" value="Low" autocomplete="off"> Low
                  </label>
                  <label class="btn btn-outline-primary btn-toggle">
                    <input type="radio" name="priority" id="option3" value="Medium" autocomplete="off"> Medium
                  </label>
                  <label class="btn btn-outline-primary btn-toggle">
                    <input type="radio" name="priority" id="option3" value="High" autocomplete="off"> High
                  </label>
                </div>
              </div>
            </div>
